...
class PixService
{
    ...
    public function __construct(
        ...
        $this->model = $modelFactory->createModel(ConfigVars::PIX);
        $this->repository = $repositoryFactory->createRepository(ConfigVars::PIX);
    ...
    public function getPaymentByRequestData($requestData)
    {
        if (isset($requestData['hash'])) {
            ...
            $data = $this->repository->getByHash($requestData['hash'])->getData();
