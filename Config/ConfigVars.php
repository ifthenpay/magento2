...
final class ConfigVars
{
	...
	/* -------------------------------------------------------------------------- */
	/*                       Callback validation fail codes                       */
	/* -------------------------------------------------------------------------- */

	const CB_FAIL_CODE_STORED_DATA_NOT_FOUND = 10; // did not find record in respective ifthenpay method table
	const CB_FAIL_CODE_INVALID_PAYMENT_METHOD = 20; // payment method not included in allowed methods
	const CB_FAIL_CODE_CALLBACK_NOT_ACTIVE = 30; // callback not active in ifthenpay method configuration
	const CB_FAIL_CODE_INVALID_ANTIPHISHING_KEY = 40; // anti-phishing key does not match
	const CB_FAIL_CODE_ORDER_NOT_FOUND = 50; // order id not found in magento's orders table
	const CB_FAIL_CODE_INVALID_AMOUNT = 60; // amount does not match order total
	const CB_FAIL_CODE_ALREADY_PAID = 90; // order already marked as paid
	...
	/* -------------------------------------------------------------------------- */
	public const CCARD_RETURN_URL_STRING = 'ifthenpay/Frontend/ReturnCcardCtrl?order_id=[ORDER_ID]&qn=[QN]';
	...
	/* -------------------------------------------------------------------------- */
	/*                          Ccard writable CONFIGURATION                      */
	/* -------------------------------------------------------------------------- */

	public const CCARD_CALLBACK_URL = 'callback_url';
	public const CCARD_ANTI_PHISHING_KEY = 'anti_phishing_key';
	public const CCARD_ACTIVATE_CALLBACK = 'activate_callback';
	public const CCARD_IS_CALLBACK_ACTIVATED = 'is_callback_activated';
