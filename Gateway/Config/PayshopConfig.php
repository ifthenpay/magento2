...
{
    public const METHOD_CODE = ConfigVars::PAYSHOP_CODE;
    private const CONFIG_PATH = ConfigVars::MODULE . '/' . ConfigVars::PAYSHOP_CODE . '/';
    ...
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_SEND_INVOICE_EMAIL);

        return $value === '1' ? true : false;
    }
    public function getKey(): string
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_KEY);
    ...
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_DEADLINE);
    ...
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_ACTIVATE_CALLBACK);
    ...
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_IS_CALLBACK_ACTIVATED);
    ...
    {
        $this->saveConfigValue(ConfigVars::PAYSHOP_CALLBACK_URL, $callbackUrl);
        $this->saveConfigValue(ConfigVars::PAYSHOP_ANTI_PHISHING_KEY, $antiPhishingKey);
        $this->saveConfigValue(ConfigVars::PAYSHOP_IS_CALLBACK_ACTIVATED, '1');
        $this->scopeConfig->clean();
    }

    public function getCallbackUrl(): string
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_CALLBACK_URL);
    ...
    {
        $value = $this->getConfigValue(ConfigVars::PAYSHOP_ANTI_PHISHING_KEY);
    ...
    {
        $this->saveConfigValue(ConfigVars::PAYSHOP_IS_CALLBACK_ACTIVATED, '0');
        $this->scopeConfig->clean();
    }
    ...
    {
        $this->deleteConfigValue(ConfigVars::PAYSHOP_KEY);
        $this->deleteConfigValue(ConfigVars::PAYSHOP_DEADLINE);
        $this->deleteConfigValue(ConfigVars::PAYSHOP_CALLBACK_URL);
        $this->deleteConfigValue(ConfigVars::PAYSHOP_ACTIVATE_CALLBACK);
        $this->deleteConfigValue(ConfigVars::PAYSHOP_IS_CALLBACK_ACTIVATED);
        $this->deleteConfigValue(ConfigVars::PAYSHOP_ANTI_PHISHING_KEY);
        $this->deleteConfigValue(ConfigVars::PAYSHOP_SEND_INVOICE_EMAIL);
